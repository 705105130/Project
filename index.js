const apiKey = '7ed0278c2c38f2471988c441472025df';
...
function fetchWeatherData(location) {
    ...
    fetch(apiUrl).then(response => response.json()).then(data =>{
        ...
        const todayWindSpeed = `${data.list[0].windspeed} km/h`;
        ...
        for(const dayData of nextDaysData) {
            ...
            // Stop after getting 4 distinct daysif
            if(count === 4) break;
...
// Fetch weather data on document load for default
